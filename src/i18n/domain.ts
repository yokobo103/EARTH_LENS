...
const missionJa: Record<string, {
  ...
  "mission-v2-01-nile": { title: "砂漠を流れる文明の川を探せ", prompt: "広大な乾燥帯を貫く大河と、その周りに生まれた文明の場所を探してください。", target: "ナイル川", sticker: ["ナイル川", "エジプト / 北東アフリカ", "ナイル、砂漠、古代文明"], hints: [["地形の手掛かり", "広い乾燥地帯を横切る大きな川を探してください。", ""], ["観測フォーカス", "観測範囲を北アフリカへ絞ります。", "北アフリカ"], ["河川シグナル", "砂漠と海の間に伸びる緑の回廊を探してください。", "ナイル回廊"]], answer: "周囲はほとんど乾燥しているのに、この一本の川だけが水を運びます。だから人と農耕と都市が、細長い緑の線に集まりました。", references: [], evidence: [["ナイル", "北アフリカを貫く大河"], ["乾燥帯", "回廊を取り囲む長期的な乾燥気候"]] },
  "mission-v2-02-mesopotamia": { title: "二本の川のあいだを探せ", prompt: "メソポタミアの二本の大河が形づくる低地を探してください。", target: "メソポタミア", sticker: ["メソポタミア", "チグリス・ユーフラテス", "二本の川と古代都市"], hints: [["二本の川の手掛かり", "二本の大きな川が近づきながら流れる低地を探してください。", ""], ["観測フォーカス", "観測範囲を中東へ絞ります。", "二本の川の低地"], ["河川平野シグナル", "チグリス川とユーフラテス川の間を探してください。", "チグリス・ユーフラテス平野"]], answer: "メソポタミアは、川と川のあいだの土地という意味です。チグリス川とユーフラテス川が、初期の都市を育てられるつながった平野をつくりました。", references: [], evidence: [["チグリス川", "二本の川の一方"], ["ユーフラテス川", "平野を形づくるもう一方の川"]] },
  "mission-v2-03-indus": { title: "インダス川の文明を探せ", prompt: "南アジアで大きな水系に沿って生まれた初期都市文明の場所を探してください。", target: "インダス川流域", sticker: ["インダス川流域", "南アジア", "河川流域と古代都市"], hints: [["水系の手掛かり", "高い山地の南側にある、乾いた低地の河川系から始めてください。", ""], ["観測フォーカス", "観測範囲を南アジアへ絞ります。", "南アジア"], ["谷のシグナル", "インダス川下流と、その周りの広い平野を探してください。", "インダス川流域"]], answer: "インダス川は、南アジア北西部の乾いた土地を横切る大きな水系です。現在の国境ではなく、川の流域そのものが初期都市の場所を示します。", references: [], evidence: [["インダス川", "南アジアを流れる大河の水系"]] },
  "mission-v2-04-yellow-river": { title: "黄河の文明を探せ", prompt: "北中国を流れる大河を追い、初期都市が集まった地域を探してください。", target: "黄河", sticker: ["黄河", "中国北部", "黄河と古代文明"], hints: [["河川の手掛かり", "北の広い平野を東へ流れる大河を追ってください。", ""], ["観測フォーカス", "観測範囲を東アジアへ絞ります。", "中国北部"], ["黄河シグナル", "その大河の中流域を探してください。", "黄河流域"]], answer: "黄河は、北中国の平野に目立つ一本の道を描きます。現代の国境からではなく、水の流れを追うことで、初期の定住地域が見えてきます。", references: [], evidence: [["黄河", "黄河として表示される主要河川"]] },
  "mission-v2-05-tokyo": { title: "巨大な湾岸都市を探せ", prompt: "日本列島の湾岸に集まる巨大な人口集積を探してください。", target: "東京", sticker: ["東京", "日本", "東京湾と巨大都市の街並み"], hints: [["人口の手掛かり", "島の列の上で、最も明るい人口集積を探してください。", ""], ["観測フォーカス", "観測範囲を日本へ絞ります。", "日本"], ["湾のシグナル", "日本最大の島の東側にある集積を探してください。", "東京湾"]], answer: "人口レンズでは、この湾が地球最大級の人の集まりとして光ります。日本の上の一点ではなく、海岸に沿って広がる明るい地域の核として見えてきます。", references: [], evidence: [["東京", "日本列島にある主要な人口集積"]] },
  "mission-v2-06-new-york": { title: "大西洋岸の巨大都市を探せ", prompt: "北米の大西洋側にある巨大な人口集積を探してください。", target: "ニューヨーク", sticker: ["ニューヨーク", "北米", "マンハッタンの街並みと港"], hints: [["沿岸人口の手掛かり", "大きな川が大西洋へ出る場所の、明るい人口集積を探してください。", ""], ["観測フォーカス", "観測範囲を北米東岸へ絞ります。", "北米東岸"], ["港のシグナル", "大陸北東部の大きな港を探してください。", "大西洋岸の巨大都市"]], answer: "北米東岸では、周囲の海岸よりひときわ明るい人口の核が見えます。港と河口が、この場所を大陸規模の都市へ育てました。", references: [], evidence: [["ニューヨーク", "北米東岸にある主要な人口集積"]] },
  "mission-v2-07-mexico-city": { title: "高地の巨大都市を探せ", prompt: "海岸から離れ、山地に囲まれた高地の盆地にある巨大都市を探してください。", target: "メキシコシティ", sticker: ["メキシコシティ", "メキシコ高原", "高地の巨大都市と火山"], hints: [["高地の手掛かり", "高い地形に囲まれた盆地の人口集積を探してください。", ""], ["観測フォーカス", "観測範囲をメキシコ中央部へ絞ります。", "メキシコ高原"], ["盆地のシグナル", "中央メキシコの山地帯の間を探してください。", "高地の盆地"]], answer: "ここは海岸ではなく、山に囲まれた高地の盆地に広がる巨大都市です。人口と地形を重ねると、港湾都市とは違う集積の形が見えてきます。", references: [], evidence: [["メキシコシティ", "中央高地にある主要な人口集積"], ["高地", "盆地を囲む山地"]] },
  "mission-v2-08-sao-paulo": { title: "南米の巨大都市を探せ", prompt: "南米大陸の南東部にある巨大な人口集積を探してください。", target: "サンパウロ", sticker: ["サンパウロ", "ブラジル", "南米の巨大都市の街並み"], hints: [["大陸の手掛かり", "赤道より南にある大きな人口集積を探してください。", ""], ["観測フォーカス", "観測範囲を南米南東部へ絞ります。", "南米南東部"], ["南米のシグナル", "ブラジル南東部の明るい核を探してください。", "ブラジルの巨大都市"]], answer: "南米にも、地球儀のスケールで見える人口の核があります。ブラジル南東部では、一つの地区を越えて広がる都市集積が明るく現れます。", references: [], evidence: [["サンパウロ", "ブラジル南東部にある主要な人口集積"]] },
};
