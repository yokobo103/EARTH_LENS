...
export const missionCatalog: readonly EarthMission[] = [
  {
    ...
    sticker: { id: "sticker-malacca", missionId: "mission-01-malacca", title: "MALACCA", region: "Southeast Asia", shape: "oval", icon: "strait", description: "Container ship and tropical strait", coordinateLabel: "2.5°N / 101.2°E" },
  ...
  },
  {
    ...
    sticker: { id: "sticker-himalayas", missionId: "mission-02-himalayas", title: "HIMALAYAS", region: "High Asia", shape: "shield", icon: "mountain", description: "Snow mountains and expedition motif", coordinateLabel: "28.2°N / 86.5°E" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-hormuz", missionId: "mission-03-hormuz", title: "HORMUZ", region: "Persian Gulf", shape: "arch", icon: "tanker", description: "Tanker and Persian Gulf sunset", coordinateLabel: "26.6°N / 56.3°E" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-suez", missionId: "mission-04-suez", title: "SUEZ CANAL", region: "Egypt", shape: "rectangle", icon: "canal", description: "Cargo ship crossing a desert canal", coordinateLabel: "30.6°N / 32.3°E" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-rotterdam", missionId: "mission-05-rotterdam", title: "ROTTERDAM", region: "North Sea", shape: "oval", icon: "port", description: "Port cranes and containers", coordinateLabel: "52.0°N / 4.1°E" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-gibraltar", missionId: "mission-06-gibraltar", title: "GIBRALTAR", region: "Western Mediterranean", shape: "shield", icon: "rock", description: "Rock and passing ship", coordinateLabel: "36.0°N / 5.6°W" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-lithium", missionId: "mission-07-lithium", title: "LITHIUM TRIANGLE", region: "Central Andes", shape: "custom", icon: "salt-flat", description: "Salt flat and Andes", coordinateLabel: "23.5°S / 67.5°W" },
    completion: { evidenceChain: [
  ...
  },
  {
    ...
    sticker: { id: "sticker-rift", missionId: "mission-08-rift", title: "EAST AFRICAN RIFT", region: "East Africa", shape: "arch", icon: "rift", description: "Rift valley and volcano", coordinateLabel: "1.5°S / 36.2°E" },
    completion: { evidenceChain: [
